...
This is a sample template for layers-demo - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name layers-demo --tail
```
...
```bash
aws cloudformation delete-stack --stack-name layers-demo
```
